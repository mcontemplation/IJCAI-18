...
#从训练集三中获取用户商品相关特征
train2_f = pd.read_csv('data/train4_f.csv')
user_commodity = train2_f
# 用户点击该商品次数
t = user_commodity[['user_id','item_id']]
t['user_item_click_total'] = 1
...
user_commodity[[ 'user_item_click_buy_rate','user_item_click_buy_total','user_item_click_total','user_item_diff',
                'user_id','item_id']].to_csv('data/user_item_feature4.csv',index=None)
...
# 该等级购买该商品率
user_commodity['star_item_click_buy_rate'] = user_commodity['star_item_click_buy_total']/user_commodity['star_item_click_total']
user_commodity[['star_item_click_buy_rate','star_item_click_buy_total','star_item_click_total','user_star_level','item_id']].to_csv('data/star_item_feature4.csv',index=None)
...
# 该年龄星级购买该商品率
user_commodity['age_star_click_buy_rate'] = user_commodity['age_star_click_buy_total']/user_commodity['age_star_click_total']
user_commodity[['age_star_click_total','age_star_click_buy_total','age_star_click_buy_rate','item_id','user_age_level','user_star_level']].to_csv('data/age_star_item_feature4.csv',index=None)
...
# #从训练集三中获取用户商品相关特征
# train2_f = pd.read_csv('data/train5_f.csv')
# user_commodity = train2_f
# # 用户点击该商品次数
# t = user_commodity[['user_id','item_id']]
# t['user_item_click_total'] = 1
...
#
# user_commodity[[ 'user_item_click_buy_rate','user_item_click_buy_total','user_item_click_total','user_item_diff',
#                 'user_id','item_id']].to_csv('data/user_item_feature5.csv',index=None)
#
# # 该等级点击该商品次数
# t = user_commodity[['user_star_level','item_id']]
# t['star_item_click_total'] = 1
...
# # 该等级购买该商品率
# user_commodity['star_item_click_buy_rate'] = user_commodity['star_item_click_buy_total']/user_commodity['star_item_click_total']
# user_commodity[['star_item_click_buy_rate','star_item_click_buy_total','star_item_click_total','user_star_level','item_id']].to_csv('data/star_item_feature5.csv',index=None)
#
#
# # 该年龄星级点击该商品次数
# t = user_commodity[['item_id','user_age_level','user_star_level']]
...
# # 该年龄星级购买该商品率
# user_commodity['age_star_click_buy_rate'] = user_commodity['age_star_click_buy_total']/user_commodity['age_star_click_total']
# user_commodity[['age_star_click_total','age_star_click_buy_total','age_star_click_buy_rate','item_id','user_age_level','user_star_level']].to_csv('data/age_star_item_feature5.csv',index=None)
