...
store[['shop_click_buy_rate','shop_click_buy_total','shop_click_total','min_sale_hour','max_sale_hour','min_age','mean_age','max_age',
       'sale_am','sale_pm','shop_cate2_btotal','shop_id']].to_csv('data/shop_feature4.csv',index=None)
# ,'shop_difuser_total'
...
#
# store[['shop_click_buy_rate','shop_click_buy_total','shop_click_total','min_sale_hour','max_sale_hour','min_age','mean_age','max_age',
#        'sale_am','sale_pm','shop_cate2_btotal','shop_id']].to_csv('data/shop_feature5.csv',index=None)
# ,'shop_difuser_total'